...
class TestPerformanceMetrics:
    ...
    def test_calculate_summary_by_type(
        self, metrics: PerformanceMetrics, sample_dataframe: pd.DataFrame
    ):
    ...
    def test_calculate_performance_grade_excellent(
        ...
        grade, emoji, explanation = metrics.calculate_performance_grade(
            sample_dataframe
        )
    ...
    def test_calculate_core_web_vitals(
        self, metrics: PerformanceMetrics, sample_dataframe: pd.DataFrame
    ):
    ...
    def test_analyze_timing_breakdown(
        self, metrics: PerformanceMetrics, sample_dataframe: pd.DataFrame
    ):
    ...
    def test_detect_performance_issues(
        self, metrics: PerformanceMetrics, sample_dataframe: pd.DataFrame
    ):
